...
class MoviesTest < ApplicationSystemTestCase
  ...
  test "creating a Movie" do
    ...
    fill_in "About movie", with: @movie.about_movie
    fill_in "Movie duration", with: @movie.movie_duration
    fill_in "Movie format", with: @movie.movie_format
    fill_in "Movie language", with: @movie.movie_language
