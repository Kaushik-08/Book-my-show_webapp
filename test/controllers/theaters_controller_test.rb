...
class TheatersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theater" do
    assert_difference('Theater.count') do
      post theaters_url, params: { theater: { theater_location: @theater.theater_location, theater_name: @theater.theater_name } }
    end
  ...
  test "should update theater" do
    patch theater_url(@theater), params: { theater: { theater_location: @theater.theater_location, theater_name: @theater.theater_name } }
